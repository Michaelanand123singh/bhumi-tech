    ...
    <section ref={sectionRef} className="py-24 bg-gradient-to-br from-green-600 to-green-700 scroll-reveal">
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        <p className="text-lg md:text-xl text-green-50 mb-10 leading-relaxed max-w-2xl mx-auto">
          Join hundreds of content creators who've transformed their business with Bhumi Technology
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link
            to="/contact"
            className="bg-green-800 text-white px-8 py-5 rounded-lg hover:bg-green-900 transition-all duration-300 font-semibold border-2 border-white/20 hover:border-white/40 flex items-center justify-center group shadow-lg"
          >
