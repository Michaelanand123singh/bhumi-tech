  ...
  return (
    <>
      ...
      <div className="relative min-h-screen bg-gradient-to-b from-white via-slate-50 to-white overflow-hidden">
        {/* Soft ambient glows - Optimized for performance */}
        ...
        <div className="relative space-y-16 md:space-y-24 lg:space-y-28">
          ...
          <section id="metrics" className="max-w-6xl mx-auto px-4 sm:px-6 w-full">
            <div className="bg-white/85 backdrop-blur-xl border border-slate-200/70 rounded-3xl shadow-2xl shadow-emerald-500/10 p-6 md:p-8 lg:p-12">
              <MetricsDashboard />
            </div>
          </section>

          <section id="stories" className="max-w-6xl mx-auto px-4 sm:px-6 w-full">
            <CaseStudies />
          </section>
          ...
          <section className="max-w-6xl mx-auto px-4 sm:px-6 w-full pb-12 md:pb-16 lg:pb-20">
            <ClientLogos />
          </section>
        </div>
      </div>
